...
dsn = "amuvarma/luna-2.6k-withtags"
...
def create_text_tokens(example):
    ...
    instruction_string = f"{example['text']}"
...
dataset_to_upload  = dataset_to_upload.shuffle(seed=42)

# Now upload the dataset with only the desired columns
dataset_to_upload.push_to_hub("amuvarma/luna-2.6k-tts-1-wtags-vad")