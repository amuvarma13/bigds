...
dsn = "amuvarma/general-wellformatted-convs-audio-snacced"
push_name = "amuvarma/general-wellformatted-convs-audio-snacced-proc"
...
for convo in mylists:
    ...
    for message in convo:
        ...
        codes_list = [i for i in codes_list]
