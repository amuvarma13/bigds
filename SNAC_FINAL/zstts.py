...
def tokenize_fn(example):
    ...
    prompt_ids = tokenizer.encode(random_instruction_prompt+" "+example["text_prompt"], add_special_tokens=True)
    response_ids = tokenizer.encode(random_instruction_response + " " + example["text_response"], add_special_tokens=True)
